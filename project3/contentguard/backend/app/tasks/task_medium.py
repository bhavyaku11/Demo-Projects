...
from ..graders.grader_medium import HateSpeechGrader, MediumMetrics
...
class HateSpeechTask:
    ...
    def __init__(self) -> None:
        data_path = Path(__file__).parent.parent / "data" / "posts_medium.json"
        with data_path.open(encoding="utf-8") as file:
            self.posts = json.load(file)
        self.grader = HateSpeechGrader()
        self.reset()
